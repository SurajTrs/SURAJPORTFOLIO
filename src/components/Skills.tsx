...
export default function Skills() {
  return (
    <section id="skills" className="section-padding bg-gradient-to-br from-muted/10 via-white to-muted/20 dark:from-blue-950/60 dark:via-blue-900/40 dark:to-blue-950/20">
